...
${dcos_resolvers== "" ? "" : "resolvers:  \n  ${indent(2,dcos_resolvers)}"}
...
${dcos_master_discovery == "static" ? dcos_master_list== "" ? "" : "master_list: \n  ${indent(2,dcos_master_list)}" : ""}
...
${dcos_fault_domain_detect_contents== "" ? "" : "fault_domain_detect_contents: | \n  ${indent(2, dcos_fault_domain_detect_contents)}"}
...
${dcos_ip_detect_contents== "" ? "" : "ip_detect_contents: | \n  ${indent(2,dcos_ip_detect_contents)}"}
${dcos_ip_detect_public_contents== "" ? "" : "ip_detect_public_contents: | \n  ${indent(2, dcos_ip_detect_public_contents)}"}
