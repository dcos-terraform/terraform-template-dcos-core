variable "dcos_download_path" {
  ...
  default = {
    ...
    "1.13.0-alpha" = "http://downloads.mesosphere.com/dcos-enterprise/stable/1.13.0-alpha/commit/633f96c6b97ee6b48eb20cbd06f92cbfc01a6622/dcos_generate_config.sh
