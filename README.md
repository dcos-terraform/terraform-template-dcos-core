...
| dcos\_ee\_download\_path |  | map | `<map>` | no |
...
| dcos\_open\_download\_path |  | map | `<map>` | no |
...
| dcos\_version | Specifies which DC/OS version instruction to use. Options: 1.12.3, 1.11.10, etc. See dcos_download_path or dcos_version tree for a full list. | string | `"1.12.2"` | no |
